...
void HPModel::initSchedule(repast::ScheduleRunner & runner) 
{
 ...
 // runner.scheduleEvent(20, repast::Schedule::FunctorPtr(new repast::MethodFunctor<HPModel> (this, &HPModel::intervene)));
...
void HPModel::intervene()
{

  mp_lumen->intervene();
  mp_epithilium->intervene();
  mp_lamina_propria->intervene();
  mp_gastric_lymph_node->intervene();
